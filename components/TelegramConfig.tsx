...
const TelegramConfig: React.FC = () => {
    ...
    const handleDisconnect = () => {
        if (window.confirm('¿Desconectar Telegram?')) {
    ...
    return (
        <div className="max-w-3xl mx-auto p-8 animate-fade-in">
            <div className="mb-8">
                ...
                <p className="text-slate-500">La forma más fácil de conectar su taller con expertos.</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-[#229ED9]/20 p-8 relative overflow-hidden">
                ...
                {status === 'connected' ? (
                    <div className="text-center py-8 animate-fade-in-up">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-2">Conectado a Telegram</h3>
                        <p className="text-slate-500 mb-8 max-w-md mx-auto">
                            Los mensajes enviados desde el chat de Solicitud de Peritación ahora se enviarán a través de su Bot de Telegram.
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div className="space-y-6">
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-2">Token del Bot</label>
                                <input
                                    type="password"
                            ...
                            <div>
                                <label className="block text-sm font-bold text-slate-700 mb-2">ID del Chat (Opcional para Demo)</label>
                                <input
                                    type="text"
                                    className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#229ED9] outline-none font-mono text-sm"
                                    value={chatId}
                            ...
                            {status === 'error' && (
                                <div className="bg-red-50 text-red-600 p-3 rounded-lg text-sm flex items-center gap-2">
                                    ...
                                    Fallo de conexión. Por favor, compruebe su token.
                                </div>
                            )}
                        ...
                        <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 text-sm text-slate-600">
                            ...
                            <ol className="list-decimal pl-5 space-y-3">
                                ...
                                <li>
                                    Envíe el comando <code className="bg-slate-200 px-1 rounded">/newbot</code> y siga las instrucciones para nombrar a su bot (ej., <em>MyWorkshopExpertBot</em>).
                                </li>
                                <li>
                                    Copie el <strong>Token API HTTP</strong> proporcionado y péguelo aquí.
                                </li>
                                <li>
                                    (Opcional) Inicie un chat con su nuevo bot, envíe un mensaje y use una herramienta como
                                    <span className="italic"> @userinfobot</span> para encontrar su ID de Chat si desea mensajes directos.
                                </li>
                            </ol>
                            <div className="mt-6 pt-4 border-t border-slate-200">
                                <p className="text-xs italic">
                                    <strong>Nota:</strong> En el Modo Demo, la interfaz de chat funcionará perfectamente pero los mensajes no se enviarán realmente a una cuenta de Telegram real.
                                </p>
                            </div>
                        </div>
                    </div>
