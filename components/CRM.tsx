...
const CRM: React.FC = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-6 min-h-[calc(100vh-2rem)]">
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">CRM y Ventas</h1>
                    <p className="text-slate-500">Gestión de presupuestos y seguimiento comercial.</p>
                </div>
                <button
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                            <table className="min-w-full divide-y divide-slate-200">
                                ...
                                <tbody className="bg-white divide-y divide-slate-200">
                                    {quotes.length === 0 && (
                                        <tr>
                                            <td colSpan={6} className="px-6 py-8 text-center text-slate-400 text-sm">No se encontraron presupuestos. ¡Cree uno!</td>
                                        </tr>
                                    )}
                                    {quotes.map(q => (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {opportunities.length === 0 && (
                                <div className="col-span-full p-12 text-center text-slate-400 bg-white rounded-xl border border-slate-200 border-dashed">
                                    No hay oportunidades futuras programadas.
                                </div>
                            )}
