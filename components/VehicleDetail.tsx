            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="text-right">
                        <p className="text-sm text-slate-500 uppercase font-bold">Fecha de Registro</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-slate-100 pt-6">
                    <div>
                        <h3 className="font-bold text-slate-700 mb-4">Información del Vehículo</h3>
                    ...
                    <div>
                        <h3 className="font-bold text-slate-700 mb-4">Propietario / Cliente</h3>
                        {client ? (
                            ...
                            <p className="text-slate-400 italic">Sin cliente vinculado.</p>
                        )}
                    </div>
                </div>
            </div>
