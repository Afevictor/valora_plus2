...
const Results: React.FC<ResultsProps> = ({ onBack }) => {
    ...
    const handleDownload = () => {
        ...
        const opt = {
            margin: [10, 10, 10, 10],
            filename: `Informe_Rentabilidad_${Date.now()}.pdf`,
    ...
    return (
        <div className="max-w-7xl mx-auto py-8">
            <div className="flex items-center justify-between mb-8 px-4">
                ...
                <div className="flex gap-3">
                    ...
                    <Button
                        ...
                        className="bg-brand-600 hover:bg-brand-700 text-white font-bold shadow-lg shadow-brand-200"
                    >
            ...
            <div ref={reportRef} className="space-y-8 p-4 bg-slate-50/30 rounded-2xl">
                {/* Header for PDF */}
                                    ...
                                    <div className="space-y-4 text-slate-300 font-medium leading-relaxed max-w-4xl">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mt-6">
                                            <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                                                ...
                                                <p className="text-sm text-slate-300">Optimización excelente en la compra de repuestos (32% de descuento medio). La eficiencia en chapa ha sido del 105% respecto al baremo.</p>
                                            </div>
                                            <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                                                <div className="flex items-center gap-2 mb-3">
                                                ...
                                                <p className="text-sm text-slate-300">El tiempo de materiales de pintura es ligeramente superior a lo estimado. Revisa la dosificación para maximizar el margen de pintura.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
